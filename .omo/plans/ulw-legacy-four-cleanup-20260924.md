...
> 性质：执行计划。裁决来源：[decisions-pending-20260924.md](../decisions-pending-20260924.md) 四项，主公 2026-09-24 批注：项1 立小票 / 项2 处理悬空与孤儿 / 项3 立小票处理 / 项4 用已有 Turso key 处理；T-L4 落点已御裁 A（生产库 + `_probe_*` 临时表，见 §五）。**当前状态：计划更新版待主公终审，未派发。**
