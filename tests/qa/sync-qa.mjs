...
//
// Why disabled: the panel mounted on /offline no longer carries the
...
// data-testid="offline-sync" and "sync-confirm-dialog" which no longer
// exist on the /offline surface.
//
// Coverage migration plan (W3 final):
//   - sync-qa step 01 "unnamed-offline-zero-network"    → subsumed by
...
//     no longer on /offline. The merge surface lives in the home-return
